...
import com.ironhack.restaurantmanagementsystem.controller.AuthController;
...
class AuthControllerTest {
    ...
    void shouldReturnConflictWhenEmailAlreadyExists() throws Exception {
        when(authService.register(any()))
                .thenThrow(new com.ironhack.restaurantmanagementsystem.exception.ConflictException(
                        "User already exists"));
